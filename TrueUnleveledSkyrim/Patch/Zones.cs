...
namespace TrueUnleveledSkyrim.Patch
{
    class ZonesPatcher
    {
        ...
        private static void UnlevelZone(EncounterZone encZone, ZoneEntry zoneDefinition)
        {
            ...
            {
                encZone.MinLevel = Convert.ToSByte(Patcher.Randomizer.Next(zoneDefinition.MinLevel, zoneDefinition.MaxLevel));
            ...
            else
            {
                ...
                {
                    encZone.MinLevel = Convert.ToSByte(Patcher.Randomizer.Next(zoneDefinition.MinLevel, zoneDefinition.MinLevel + zoneDefinition.Range));
                    encZone.MaxLevel = 0;
                }
                else
                {
                    encZone.MinLevel = Convert.ToSByte(Patcher.Randomizer.Next(zoneDefinition.MinLevel, zoneDefinition.MaxLevel - zoneDefinition.Range + 1));
                    encZone.MaxLevel = Convert.ToSByte((encZone.MinLevel + zoneDefinition.Range));
                }
            }
        }
